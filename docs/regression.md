...
## memz — meme party game + solo creator (`tests/test_spr_z_1.py` through `tests/test_spr_z_6.py` (190 total), `tests/test_memz_screens.py` (31), plus 5 entries in `tests/test_smoke.py`)
