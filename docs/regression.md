...
## memz — meme party game + solo creator (`tests/test_spr_z_1.py` through `tests/test_spr_z_7.py` (198 total), `tests/test_memz_screens.py` (31), plus 5 entries in `tests/test_smoke.py`)
