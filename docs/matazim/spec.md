...
| REQ-M.141 | A dashboard for this app | Rule 4's third item, and the one still missing. מט״צים has a spec, a backlog, a test plan and now a data model, but no live progress view of its own like `docs/dashboard.html`. Recorded rather than quietly skipped. | TODO |
