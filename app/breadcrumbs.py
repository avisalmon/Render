...
TRAILS = {
    ...
    "courses_detail": [("הדרכות", "courses_catalog"), ("הדרכה", None)],
    "courses_lesson": [("הדרכות", "courses_catalog"), ("הדרכה", None), ("שיעור", None)],
    "course_detail": [("הדרכות", "courses_catalog"), ("הדרכה", None)],
    "lesson_view": [("הדרכות", "courses_catalog"), ("הדרכה", None), ("שיעור", None)],
    ...
    "studio_course_create": [("אולפן", "studio_home"), ("הדרכה חדשה", None)],
    "studio_new_from_video": [("אולפן", "studio_home"), ("הדרכה מסרטון", None)],
    "studio_course_edit": [("אולפן", "studio_home"), ("עריכת הדרכה", None)],
    "studio_lesson_new": [("אולפן", "studio_home"), ("עריכת הדרכה", None), ("שיעור חדש", None)],
    "studio_lesson_edit": [("אולפן", "studio_home"), ("עריכת הדרכה", None), ("עריכת שיעור", None)],
