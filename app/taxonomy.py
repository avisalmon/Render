...
TRAINING_TAXONOMY = {
    "matazim": {
        ...
        "order": 1,
        "description": (
            "הכשרת בני נוער למובילים טכנולוגיים - הדרכות מעשיות בתכנות, חומרה, "
    ...
    "science": {
        "title": "מדע וגילוי",
        "subtitle": "פיזיקה דרך ניסוי וסקרנות",
        "icon": "bi-magnet",
        "order": 4,
        "description": (
            "לומדים פיזיקה בגילוי: חוֹזים, מוֹדדים בעזרת חפצים פשוטים והטלפון, "
            "ואז מנַסחים את המודל. כל נושא הוא שאלה שבודקים בניסוי, לא נוסחה לשינון."
        ),
        "tracks": {
            "physics": {
                "title": "מעבדת פיזיקה בכיס",
                "subtitle": "ניסויי פיזיקה עם הטלפון וחפצים מהבית",
